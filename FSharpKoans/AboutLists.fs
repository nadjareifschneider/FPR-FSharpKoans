...
module ``about lists`` =
    ...
    let CreatingLists() =
        ...
        AssertEquality list.Tail ["pear"; "grape"; "peach"] //without first element
        ...
        AssertInequality (list.GetType()) (dotNetList.GetType()) //NOT EQUAL
    ...
    (* THINK ABOUT IT: In general, what performs better for building lists, 
       ...
       // the performance of :: is better
       // @ has to move every element of the list
    ...
    let CreatingListsWithComprehensions() =
        let list = [for i in 0..4 do yield i ] //yield: interator
    ...
    let DividingListsWithPartition() =
        ...
        AssertEquality result1 [1;3;5] //for which the given predicate returns true
        AssertEquality result2 [0;2;4] //for which the predicate returns false
